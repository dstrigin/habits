        ...
        children: [
          RichText(
            ...
            children: <TextSpan> [
              ...
              TextSpan(text: ' будут отображаться все привычки, которые у вас есть на данный момент.\n\n    Чтобы добавить привычку нажмите на '),
              TextSpan(text: '"плюс"', style: TextStyle(fontWeight: FontWeight.bold)),
              TextSpan(text: ' - вы увидите список распространенных привычек, представленный нами, и сможете выбрать то, что подходит вам (а в поздних версиях - создать свою привычку). Для этого нажмите на ее название и кнопку "добавить" во всплывшем окне.\n\n'),
